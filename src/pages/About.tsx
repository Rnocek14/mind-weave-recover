    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="border-b border-border/50 backdrop-blur-sm bg-background/80 sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-foreground tracking-tight">MindWeave</span>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
        ...
        <p className="mt-6 text-lg text-muted-foreground max-w-2xl leading-relaxed">
          MindWeave is a clinician-informed digital practice tool for people recovering from stroke-related 
      ...
      <section className="max-w-5xl mx-auto px-6 py-12 border-t border-border/40">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              MindWeave fills the post-discharge gap with adaptive practice that continuously adjusts to 
      ...
      <section className="max-w-5xl mx-auto px-6 py-12 border-t border-border/40">
        ...
        <p className="text-muted-foreground mb-10">What makes MindWeave different from generic brain-training apps.</p>

        <div className="grid md:grid-cols-2 gap-6">
          <CapabilityCard
            icon={<FileText className="w-5 h-5" />}
            title="Clinical Note Parsing"
            description="Upload clinical documents and MindWeave automatically extracts diagnosis, lesion location, aphasia type, and severity to personalise the practice plan from day one."
          />
          <CapabilityCard
      ...
      <section className="max-w-5xl mx-auto px-6 py-12 border-t border-border/40">
        ...
        <p className="text-muted-foreground mb-8">MindWeave is designed to complement professional therapy, not replace it.</p>
        ...
        <div className="rounded-2xl bg-muted/50 p-8 md:p-10">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                MindWeave is a structured home practice tool informed by the ICF framework and 
      ...
      <footer className="max-w-5xl mx-auto px-6 py-10 border-t border-border/40">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-muted-foreground text-sm">
            ...
            <span>MindWeave — Continuous Recovery Intelligence</span>
          </div>
