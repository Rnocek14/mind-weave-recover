...
export const SEMANTIC_TRIALS: SemanticFeatureTrial[] = [
  ...
  // ============================================================
  // Path 2 fill — added to bring per-bank-difficulty d2/d3/d4 to ≥20.
  // No engine, hook, or bridge changes. PHOTO_BANK gating still applies.
  // ============================================================

  // --- d2 (+7): high/medium frequency, perceptual + functional features ---
  { word: 'ball', imageCategory: 'ball', difficulty: 2, wordFrequency: 'high',
    correctFeatures: [
      { text: 'round', category: 'perceptual', abstractness: 1 },
      { text: 'you throw it', category: 'functional', abstractness: 2 },
      { text: 'toy', category: 'categorical', abstractness: 2 },
  ...
  { word: 'fork', imageCategory: 'fork', difficulty: 2, wordFrequency: 'high',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'you eat it', category: 'functional', abstractness: 2 },
      { text: 'made of metal', category: 'associative', abstractness: 3 },
  ...
  { word: 'sock', imageCategory: 'sock', difficulty: 2, wordFrequency: 'high',
    correctFeatures: [
      { text: 'clothing', category: 'categorical', abstractness: 2 },
      { text: 'you wear it', category: 'functional', abstractness: 2 },
      { text: 'soft', category: 'perceptual', abstractness: 2 },
  ...
  { word: 'drum', imageCategory: 'drum', difficulty: 2, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'it makes sound', category: 'functional', abstractness: 3 },
      { text: 'round', category: 'perceptual', abstractness: 1 },
      { text: 'toy', category: 'categorical', abstractness: 2 },
  ...
  { word: 'fan', imageCategory: 'fan', difficulty: 2, wordFrequency: 'high',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'it makes sound', category: 'functional', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
  ...
  { word: 'coat', imageCategory: 'coat', difficulty: 2, wordFrequency: 'high',
    correctFeatures: [
      { text: 'clothing', category: 'categorical', abstractness: 2 },
      { text: 'you wear it', category: 'functional', abstractness: 2 },
      { text: 'soft', category: 'perceptual', abstractness: 2 },
  ...
  { word: 'pen', imageCategory: 'pen', difficulty: 2, wordFrequency: 'high',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'you write with it', category: 'functional', abstractness: 2 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
  ...
  // --- d3 (+13): medium frequency, categorical + associative emphasis ---
  { word: 'envelope', imageCategory: 'envelope', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'container', category: 'categorical', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
  ...
  { word: 'ladder', imageCategory: 'ladder', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'large', category: 'perceptual', abstractness: 1 },
  ...
  { word: 'candle', imageCategory: 'candle', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'found indoors', category: 'associative', abstractness: 3 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
      { text: 'common', category: 'abstract', abstractness: 4 },
    ],
    typicalDistractors: [
  ...
  { word: 'basket', imageCategory: 'basket', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'container', category: 'categorical', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'made of wood', category: 'associative', abstractness: 3 },
  ...
  { word: 'nail', imageCategory: 'nail', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
  ...
  { word: 'bell', imageCategory: 'bell', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'it makes sound', category: 'functional', abstractness: 3 },
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
  ...
  { word: 'pin', imageCategory: 'pin', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
  ...
  { word: 'lock', imageCategory: 'lock', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
  ...
  { word: 'rope', imageCategory: 'rope', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'made of wood', category: 'associative', abstractness: 3 },
  ...
  { word: 'jar', imageCategory: 'jar', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'container', category: 'categorical', abstractness: 3 },
      { text: 'made of glass', category: 'associative', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
  ...
  { word: 'iron', imageCategory: 'iron', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
  ...
  { word: 'ramp', imageCategory: 'ramp', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'large', category: 'perceptual', abstractness: 1 },
      { text: 'found outdoors', category: 'associative', abstractness: 3 },
  ...
  { word: 'web', imageCategory: 'web', difficulty: 3, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'found outdoors', category: 'associative', abstractness: 3 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
      { text: 'natural', category: 'abstract', abstractness: 4 },
  ...
  // --- d4 (+9): medium/low frequency, abstract reasoning required ---
  { word: 'parachute', imageCategory: 'parachute', difficulty: 4, wordFrequency: 'low',
    correctFeatures: [
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'large', category: 'perceptual', abstractness: 1 },
      { text: 'used for travel', category: 'associative', abstractness: 4 },
  ...
  { word: 'helicopter', imageCategory: 'helicopter', difficulty: 4, wordFrequency: 'medium',
    correctFeatures: [
      { text: 'vehicle', category: 'categorical', abstractness: 2 },
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'used for travel', category: 'associative', abstractness: 4 },
  ...
  { word: 'xylophone', imageCategory: 'xylophone', difficulty: 4, wordFrequency: 'low',
    correctFeatures: [
      { text: 'it makes sound', category: 'functional', abstractness: 3 },
      { text: 'made of wood', category: 'associative', abstractness: 3 },
      { text: 'toy', category: 'categorical', abstractness: 2 },
  ...
  { word: 'pyramid', imageCategory: 'pyramid', difficulty: 4, wordFrequency: 'low',
    correctFeatures: [
      { text: 'building', category: 'categorical', abstractness: 2 },
      { text: 'large', category: 'perceptual', abstractness: 1 },
      { text: 'found outdoors', category: 'associative', abstractness: 3 },
  ...
  { word: 'octopus', imageCategory: 'octopus', difficulty: 4, wordFrequency: 'low',
    correctFeatures: [
      { text: 'animal', category: 'categorical', abstractness: 2 },
      { text: 'living thing', category: 'categorical', abstractness: 3 },
      { text: 'has legs', category: 'associative', abstractness: 2 },
  ...
  { word: 'anvil', imageCategory: 'anvil', difficulty: 4, wordFrequency: 'low',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'heavy', category: 'perceptual', abstractness: 2 },
  ...
  { word: 'harmonica', imageCategory: 'harmonica', difficulty: 4, wordFrequency: 'low',
    correctFeatures: [
      { text: 'it makes sound', category: 'functional', abstractness: 3 },
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
  ...
  { word: 'hammock', imageCategory: 'hammock', difficulty: 4, wordFrequency: 'low',
    correctFeatures: [
      { text: 'you sit on it', category: 'functional', abstractness: 2 },
      { text: 'found outdoors', category: 'associative', abstractness: 3 },
      { text: 'soft', category: 'perceptual', abstractness: 2 },
  ...
  { word: 'thimble', imageCategory: 'thimble', difficulty: 4, wordFrequency: 'low',
    correctFeatures: [
      { text: 'tool', category: 'categorical', abstractness: 2 },
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
  ...
  // === L8 unlock expansion (d=5: 9 → 20) ===
  // Calibrated to the empirical d=5 register (accordion/stethoscope/…):
  // low-frequency nouns, 4–5 correct features with ≥2 abstractness-5
  // abstract features, concrete perceptual/associative anchors, and
  // distractors that are mostly concrete/categorical errors plus at most
  // one abstract near-miss (e.g. modern↔ancient, common↔specialized).
  { word: 'gavel', imageCategory: 'gavel', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'made of wood', category: 'associative', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'used for work', category: 'associative', abstractness: 4 },
  ...
  { word: 'easel', imageCategory: 'easel', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'made of wood', category: 'associative', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'used for work', category: 'associative', abstractness: 4 },
  ...
  { word: 'abacus', imageCategory: 'abacus', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'made of wood', category: 'associative', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'ancient', category: 'abstract', abstractness: 5 },
  ...
  { word: 'loom', imageCategory: 'loom', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'made of wood', category: 'associative', abstractness: 3 },
      { text: 'large', category: 'perceptual', abstractness: 1 },
      { text: 'used for work', category: 'associative', abstractness: 4 },
  ...
  { word: 'quill', imageCategory: 'quill', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'you write with it', category: 'functional', abstractness: 2 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
      { text: 'soft', category: 'perceptual', abstractness: 2 },
  ...
  { word: 'medal', imageCategory: 'medal', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'shiny', category: 'perceptual', abstractness: 2 },
      { text: 'small', category: 'perceptual', abstractness: 1 },
  ...
  { word: 'scroll', imageCategory: 'scroll', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'made of paper', category: 'associative', abstractness: 3 },
      { text: 'you read it', category: 'functional', abstractness: 2 },
      { text: 'ancient', category: 'abstract', abstractness: 5 },
  ...
  { word: 'harp', imageCategory: 'harp', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'large', category: 'perceptual', abstractness: 1 },
      { text: 'made of wood', category: 'associative', abstractness: 3 },
      { text: 'used for entertainment', category: 'associative', abstractness: 4 },
  ...
  { word: 'periscope', imageCategory: 'periscope', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'used for travel', category: 'associative', abstractness: 4 },
  ...
  { word: 'metronome', imageCategory: 'metronome', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'it makes sound', category: 'functional', abstractness: 3 },
      { text: 'you use it', category: 'functional', abstractness: 2 },
      { text: 'used for entertainment', category: 'associative', abstractness: 4 },
  ...
  { word: 'typewriter', imageCategory: 'typewriter', difficulty: 5, wordFrequency: 'low',
    correctFeatures: [
      { text: 'made of metal', category: 'associative', abstractness: 3 },
      { text: 'you write with it', category: 'functional', abstractness: 2 },
      { text: 'used for work', category: 'associative', abstractness: 4 },
