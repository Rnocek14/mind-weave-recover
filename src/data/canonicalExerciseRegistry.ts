...
export const CANONICAL_EXERCISES: CanonicalExercise[] = [
  ...
  },
  {
    ...
    cognitiveDomains: ["semantic_depth", "lexical_retrieval"],
    hasSpeechOutput: false,
    clinicalRationale: "Trains semantic flexibility and alternative word access — critical for circumlocution strategies in aphasia.",
    outcomeMetrics: ["word_mastery"],
    expectedGain: "Greater semantic flexibility and alternative word retrieval",
    focusAreas: ["semantic_understanding", "word_retrieval"],
    functionalMeaning: "Helps find alternative words when the first one won't come",
  },
  {
