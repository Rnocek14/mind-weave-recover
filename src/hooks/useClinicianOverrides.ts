/**
 * Fetches active clinician overrides for a profile.
 * Used by WhyThisPlan and the review page to show live config state.
 */
...
export function useClinicianOverrides(profileId: string | undefined) {
  ...
  return { overrides, activeOverrides, recentOverrides, isLoading };
}
