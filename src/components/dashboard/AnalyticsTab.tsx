/**
 * Analytics Tab - "At-a-glance intelligence"
 * 
 ...
 * 
 * Each card links to deep dive on Insights page.
 */
...
import { AnalyticsSnapshotCard } from "./AnalyticsSnapshotCard";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <AnalyticsSnapshotCard
          ...
          linkTo="/insights?section=progress"
        ...
        <AnalyticsSnapshotCard
          ...
          linkTo="/insights?section=challenges"
        ...
        <AnalyticsSnapshotCard
          ...
          linkTo="/insights?section=strategies"
        ...
        <AnalyticsSnapshotCard
          ...
          linkTo="/insights?section=alerts"
