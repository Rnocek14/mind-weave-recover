/**
 * Meaning Match — Clinical Level → Engine Difficulty bridge.
 *
 * Meaning Match's in-game adapter uses the universal 1–10 difficulty tier.
 * This bridge maps the persistent Clinical Level (1–8) to a FLOOR on that
 * tier; live session adaptation may still escalate above the floor.
 *
...
export function resolveEffectiveMeaningMatchInitialDifficulty(args: {
